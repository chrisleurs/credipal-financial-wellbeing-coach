...
export const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* What is Credipal Section - IMPROVED CONTRAST */}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-lg mx-2 md:mx-0 border border-gray-100">
              ...
              <div className="grid grid-cols-2 md:flex md:flex-wrap md:justify-center gap-2 md:gap-4 text-xs md:text-sm">
                <span className="bg-primary text-white px-3 py-2 rounded-full font-semibold shadow-md">
                  🎯 Coach Personal
                </span>
                <span className="bg-secondary text-white px-3 py-2 rounded-full font-semibold shadow-md">
